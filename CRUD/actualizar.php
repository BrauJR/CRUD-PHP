...
<div class="container-table" class="container-table--edit">
  <div class="table--title table--title--edit">Datos de Actores </div>
     ...
     <div class="table--item">
      <a href="actualizar1.php?id=<?php echo $row["id_Actor"];?>" class="table--item--link"> Editar | </a> 
      <a href="procesar_eliminar.php?id=<?php echo $row["id_Actor"];?>" class="table--item--link"> Eliminar </a>
     </div>
